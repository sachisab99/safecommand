...
| Ops Console: Next.js scaffold | ✅ Complete | Next.js 16 + Tailwind, proxy.ts auth guard, cookie session |
| Ops Console: venue onboarding wizard | ✅ Complete | BR-02 — form → `generate_venue_code()` → SC-[TYPE]-[CITY]-[SEQ] auto-generated |
| Ops Console: floor + zone editor | ✅ Complete | BR-03 — floors + zones per floor, two-person-required toggle |
...
1. **✅ Firebase Admin SDK wired into api** — DONE 2026-04-29
2. **✅ Ops Console built** — DONE 2026-04-30 (venue wizard, floors/zones, templates, staff — all 4 BRs)

3. **Run Gate 2** — Start `localhost:3001`, log in, create venue → 3 floors → 12 zones → 5 templates → 1 SH account ← **DO THIS NOW**
